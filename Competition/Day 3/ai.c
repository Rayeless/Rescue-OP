...
(PositionX!=0&&PositionY!=0))
    ...
    else if(PositionX>=110 && PositionX<=120 && PositionY>=0 && PositionY<=115&&(LoadedObjects>=6))
    {
        Duration = 0;
        CurAction =2;
    }
    else if((Black>=2&&LoadedObjects>=6))
    {
        Duration = 0;
        CurAction =3;
    }
...
if (PositionY >= 102 && PositionY <= 108){
