...
void Game0()
{
    ...
    else if(CSLeft_R>=200 && CSLeft_R<=255 && CSLeft_G>=120 && CSLeft_G<=160 && CSLeft_B>=0 && CSLeft_B<=10 && CSRight_R>=200 && CSRight_R<=255 && CSRight_G>=120 && CSRight_G<=160 && CSRight_B>=0 && CSRight_B<=10&&(LoadedObjects>=3))
    {
        Duration = 59;
        CurAction =2;
    }
...
if (US_Front <= 8 && US_Left <= 8 && US_Right <= 8){
...
WheelRight = -2;
 ...
 Duration = 128;
            if(CSRight_R>=200 && CSRight_R<=255 && CSRight_G>=120 && CSRight_G<=160 && CSRight_B>=0 && CSRight_B<=10 ||(LoadedObjects=0||(CSLeft_B<10&&CSLeft_G>120||CSLeft_G<160&&CSLeft_R>200))) Duration=0;
            break;
        case 4:
            WheelLeft=5;
            WheelRight=5;
