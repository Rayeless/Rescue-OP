...
void Game0()
{
    ...
    else if(Time>=260 && Time<=1000&&(LoadedObjects==0))
    {
        Duration = 0;
        CurAction =1;
    }
...
(LoadedObjects!=0))
    ...
    else if(((CSLeft_B>200&&CSLeft_G<70&&CSLeft_R>=200)
||
(CSRight_R>=200&&CSRight_G<70&&CSRight_B>200))
...
}else if(Compass < 90 || Compass > 280){
...
}else if(Compass > 100 && Compass < 270){
...
AlgW1 = 2;
 ...
 Duration = 128;
            if(CSLeft_R>=200 && CSLeft_R<=255 && CSLeft_G>=120 && CSLeft_G<=160 && CSLeft_B>=0 && CSLeft_B<=10 && CSRight_R>=200 && CSRight_R<=255 && CSRight_G>=120 && CSRight_G<=160 && CSRight_B>=0 && CSRight_B<=10) Duration=0;
            break;
        case 6:
            WheelLeft=0;
            WheelRight=0;
...
void Game1()
{
    ...
    else if((PositionX<=5||PositionX>=350||PositionY<=5||PositionY>=260)
...
Red<2)
    ...
    else if((LoadedObjects>3)&&((PositionX>=190&&PositionX<=210)&&(PositionY>=220&&PositionY<=260))&&(PositionX!=0&&PositionY!=0))
    {
        Duration = 0;
        CurAction =5;
    }
    else if(((PositionX>=175&&PositionX<=220)&&(PositionY>=135&&PositionY<=145))&&(PositionX!=0&&PositionY!=0))
    {
        Duration = 0;
        CurAction =6;
    }
    else if(PositionX>=30 && PositionX<=50 && PositionY>=8 && PositionY<=67&&(Red>=2))
    {
        Duration = 0;
        CurAction =7;
    }
    ...
    else if(PositionX>=5 && PositionX<=60 && PositionY>=235 && PositionY<=255)
    {
        Duration = 0;
        CurAction =9;
    }
    else if(PositionX>=61 && PositionX<=300 && PositionY>=235 && PositionY<=257&&(Black<2))
    {
        Duration = 128;
        CurAction =10;
    }
    else if(PositionX>=315 && PositionX<=360 && PositionY>=235 && PositionY<=255)
    {
        Duration = 0;
        CurAction =11;
    }
    else if(PositionY>=124 && PositionY<=228&&(Cyan<2))
    {
        Duration = 128;
        CurAction =12;
    }
    else if(CSLeft_R>=200 && CSLeft_R<=255 && CSLeft_G>=120 && CSLeft_G<=160 && CSLeft_B>=0 && CSLeft_B<=10 && CSRight_R>=200 && CSRight_R<=255 && CSRight_G>=120 && CSRight_G<=160 && CSRight_B>=0 && CSRight_B<=10&&(LoadedObjects>=6||(Time>210)))
    {
        Duration = 49;
        CurAction =13;
    }
    else if(CSLeft_R>=200 && CSLeft_R<=255 && CSLeft_G>=120 && CSLeft_G<=160 && CSLeft_B>=0 && CSLeft_B<=10 && CSRight_R>=200 && CSRight_R<=255 && CSRight_G>=120 && CSRight_G<=160 && CSRight_B>=0 && CSRight_B<=10&&(LoadedObjects=0))
    {
        Duration = 0;
        CurAction =14;
    }
...
}else if (Compass < 265 && Compass >= 90){
...
if (PositionX < 61 || PositionX > 200 || PositionY < 235 || PositionY > 257){
...
WheelRight = 3;
 ...
 Duration = 128;
            if(((CSLeft_B<=50&&CSLeft_G<=50&&CSLeft_R<=50)||(CSRight_B<=50&&CSRight_G<=50&&CSRight_R<=50))||PositionX>207) Duration=0;
            break;
        case 11:
            WheelLeft=-5;
            WheelRight=-5;
...
}else if (Compass < 355 && Compass >= 180){
...
WheelRight = -2;
 ...
 Duration = 128;
            if(PositionY>=240||((CSLeft_B>=230&&CSLeft_G>=230&&CSLeft_R<=50)||(CSRight_B>=230&&CSRight_G>=230&&CSRight_R<=50))
) Duration=0;
            break;
        case 13:
            WheelLeft=0;
