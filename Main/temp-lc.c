...
void Game0()
{
    ...
    else if(CSLeft_R>=0 && CSLeft_R<=10 && CSLeft_G>=90 && CSLeft_G<=120 && CSRight_R>=0 && CSRight_R<=10 && CSRight_G>=90 && CSRight_G<=120 && CSRight_B>=200 && CSRight_B<=255)
    {
        Duration = 1;
        CurAction =2;
    }
...
void Game1()
{
    ...
    else if((((CSLeft_R>180&&CSLeft_G>=120&&CSLeft_G<150&&CSLeft_B<40)&&(CSRight_R>180&&CSRight_G>=120&&CSRight_G<150&&CSRight_B<40))&&LoadedObjects>0))
    {
        Duration = 59;
        CurAction =2;
    }
    ...
    else if(((CSLeft_B>=220&&CSLeft_G>=220&&CSLeft_R<=50)||(CSRight_B>=220&&CSRight_G>=220&&CSRight_R<=50))&&LoadedObjects<6
)
    {
        Duration = 49;
        CurAction =4;
